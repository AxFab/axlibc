...
int main ()
{
  ...
  snprintf (str, STR_LENGTH, "INTEGER %07d|%#6i|%+12u|%+12o|%-34x|%-9.4X|%-9.4d",
    (int)64966,(int)0,(int)-8764,(int)763109,(int)-7,(int)0,(int)73);
  TEST_STR ("Integer type format #4", str, "INTEGER 0064966|     0|  4294958532|     2722345|fffffff9                          |0000     |0073     ");

  snprintf (str, STR_LENGTH, "INTEGER %#10d|%-08i|%+9u|%21o|%#7x|% 9X|%-7d",
    (int)0,(int)-453435,(int)4654564,(int)0,(int)20306,(int)-9783,(int)89);
  TEST_STR ("Integer type format #5", str, "INTEGER          0|-453435 |  4654564|                    0| 0x4f52| FFFFD9C9|89     ");

  snprintf (str, STR_LENGTH, "INTEGER %-# 9.3d|%-#+5i|%04.3u|%-34o|%#12x|% 7X|%1.9d",
    (int)-87654,(int)36,(int)0,(int)-89900,(int)0,(int)8465,(int)-954);
  TEST_STR ("Integer type format #6", str, "INTEGER -87654   |+36  | 000|37777520324                       |           0|   2111|-000000954");
  ...
  snprintf (str, STR_LENGTH, "CHARS %lc|%lc|%lc|%ls|%ls|%ls", (char)'c', 0x14c9, (char)87546, "Hello world", "", "c library");
  TEST_STR ("Wide character type format #1", str, "");

  snprintf (str, STR_LENGTH, "POINTER %p|%p|%p|%p|%p|%p|%p|%p",
    (void*)0x12345678, (void*)0, (void*)0xccccccc, (void*)46846464, (void*)0xaf1268465, (void*)0xdead, (void*)3, (void*)0xc0ffee);
  TEST_STR ("Pointer type format #1", str, "POINTER 0x12345678|(nil)|0xccccccc|0x2cad200|0xf1268465|0xdead|0x3|0xc0ffee");
