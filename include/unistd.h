...
#define F_LOCK    0x1  ///< Lock a section for exclusive use.
#define F_ULOCK   0x2  ///< Unlock locked sections.
#define F_TEST    0x4  ///< Test section for locks by other processes.
#define F_TLOCK   0x8  ///< Test and lock a section for exclusive use.

// Constants for standard stream
